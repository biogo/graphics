	...
	}{
		{
			...
			actions: []interface{}{
				...
				stroke{path: vg.Path{
					...
					{Type: vg.ArcComp, Pos: vg.Point{X: 152.5, Y: 152.5}, Radius: 110.0, Start: 6.2517693806436885, Angle: -1.7009436868899357},
				}},
				setColor{col: color.Gray16{Y: 0x0}},
				setWidth{w: 1},
				setLineDash{dashes: []vg.Length(nil), offsets: 0},
				...
				push{},
				translate{x: 271.73038059190674, y: 145.8440904709192},
				rotate{angle: 4.656622921172369},
				translate{x: -271.73038059190674, y: -145.8440904709192},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 264.70889621690674, y: 143.4942369552942, str: "8e+05"},
				pop{},
				push{},
				translate{x: 253.46436879948538, y: 88.7318181169343},
				rotate{angle: 4.149064136880077},
				translate{x: -253.46436879948538, y: -88.7318181169343},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 244.35792348698538, y: 86.3819646013093, str: "8.4e+05"},
				pop{},
				push{},
				translate{x: 209.74193847167055, y: 47.697589399118655},
				rotate{angle: 3.641505352587785},
				translate{x: -209.74193847167055, y: -47.697589399118655},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 200.63549315917055, y: 45.347735883493655, str: "8.8e+05"},
				pop{},
				push{},
				translate{x: 151.58694385569558, y: 33.08747504458508},
				rotate{angle: 3.1339465682954932},
				translate{x: -151.58694385569558, y: -33.08747504458508},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 142.48049854319558, y: 30.737621528960076, str: "9.2e+05"},
				pop{},
				setColor{col: color.Gray16{Y: 0x0}},
				setWidth{w: 1},
				setLineDash{dashes: []vg.Length(nil), offsets: 0},
				stroke{path: vg.Path{
					...
					{Type: vg.ArcComp, Pos: vg.Point{X: 152.5, Y: 152.5}, Radius: 110.0, Start: 4.487993840681956, Angle: -1.367794789850083},
				}},
				setColor{col: color.Gray16{Y: 0x0}},
				setWidth{w: 1},
				setLineDash{dashes: []vg.Length(nil), offsets: 0},
				...
				push{},
				translate{x: 100.0492666233929, y: 45.219501511195816},
				rotate{angle: 2.6868546486056104},
				translate{x: -100.0492666233929, y: -45.219501511195816},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 90.9428213108929, y: 42.869647995570816, str: "7.5e+05"},
				pop{},
				push{},
				translate{x: 63.94470324729461, y: 72.38667898039347},
				rotate{angle: 2.3061855603863917},
				translate{x: -63.94470324729461, y: -72.38667898039347},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 54.83825793479461, y: 70.03682546476847, str: "7.8e+05"},
				pop{},
				push{},
				translate{x: 40.51838045951709, y: 111.0234804637518},
				rotate{angle: 1.9255164721671725},
				translate{x: -40.51838045951709, y: -111.0234804637518},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 31.41193514701709, y: 108.6736269481268, str: "8.1e+05"},
				pop{},
				setColor{col: color.Gray16{Y: 0x0}},
				setWidth{w: 1},
				setLineDash{dashes: []vg.Length(nil), offsets: 0},
				stroke{path: vg.Path{
					...
					{Type: vg.ArcComp, Pos: vg.Point{X: 152.5, Y: 152.5}, Radius: 110.0, Start: 3.057367197760077, Angle: -3.0259512712241787},
				}},
				setColor{col: color.Gray16{Y: 0x0}},
				setWidth{w: 1},
				setLineDash{dashes: []vg.Length(nil), offsets: 0},
				...
				push{},
				translate{x: 70.95836517851578, y: 239.74188545870587},
				rotate{angle: 0.7516384402795491},
				translate{x: -70.95836517851578, y: -239.74188545870587},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 61.85191986601578, y: 237.39203194308087, str: "3.6e+05"},
				pop{},
				push{},
				translate{x: 153.65828568164704, y: 271.91039804820156},
				rotate{angle: -0.009699736158889083},
				translate{x: -153.65828568164704, y: -271.91039804820156},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 144.55184036914704, y: 269.56054453257656, str: "4.2e+05"},
				pop{},
				push{},
				translate{x: 235.71863202072262, y: 238.14370421898974},
				rotate{angle: -0.7710379125973268},
				translate{x: -235.71863202072262, y: -238.14370421898974},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 226.61218670822262, y: 235.79385070336474, str: "4.8e+05"},
				pop{},
				push{},
				translate{x: 271.8278905998036, y: 157.08686306221975},
				rotate{angle: -1.5323760890357647},
				translate{x: -271.8278905998036, y: -157.08686306221975},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 262.7214452873036, y: 154.73700954659475, str: "5.4e+05"},
				pop{},
			},
		},
		{
	...
	for i, t := range []struct {
	...
	}{
		{
			...
			actions: []interface{}{
				...
				translate{x: -222.42645352489086, y: -67.5865670377691},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 204.07928555614086, y: 62.8868600065191, str: "feature0"},
				pop{},
				push{},
				...
				translate{x: -65.7699896318745, y: -84.83978050918812},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 47.422821663124495, y: 80.14007347793812, str: "feature1"},
				pop{},
				push{},
				...
				translate{x: -155.4041866116104, y: -262.46165559014173},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 137.0570186428604, y: 257.76194855889173, str: "feature2"},
				pop{},
			},
		},
		{
		...
		},
		{
			...
			actions: []interface{}{
				...
				translate{x: -222.42645352489086, y: -67.5865670377691},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 222.42645352489086, y: 62.8868600065191, str: "feature0"},
				pop{},
				push{},
				translate{x: 65.7699896318745, y: 84.83978050918812},
				rotate{angle: 3.804096445756915},
				translate{x: -65.7699896318745, y: -84.83978050918812},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 65.7699896318745, y: 80.14007347793812, str: "feature1"},
				pop{},
				push{},
				translate{x: 155.4041866116104, y: 262.46165559014173},
				rotate{angle: 1.5443915621479876},
				translate{x: -155.4041866116104, y: -262.46165559014173},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 155.4041866116104, y: 257.76194855889173, str: "feature2"},
				pop{},
			},
		},
		{
	...
	for i, t := range []struct {
	...
	}{
		{
			...
			actions: []interface{}{
				...
				translate{x: -222.42645352489083, y: -67.5865670377691},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 210.19256680614083, y: 62.8868600065191, str: "Label"},
				pop{},
			},
		},
		{
		...
		},
		{
			...
			actions: []interface{}{
				...
				translate{x: -222.42645352489083, y: -67.5865670377691},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 10, x: 222.42645352489083, y: 62.8868600065191, str: "Label"},
				pop{},
			},
		},
		{
...
func (s *S) TestLabelSpokes(c *check.C) {
	...
	base.append(
		...
		translate{x: -93.78928237068799, y: -42.145790132631575},
		setColor{col: color.Gray16{Y: 0x0}},
		fillString{font: "Helvetica", size: 10, x: 75.44211440193799, y: 37.446083101381575, str: "feature1"},
		pop{},
		push{},
		...
		translate{x: -62.60713823573505, y: -65.64222312405899},
		setColor{col: color.Gray16{Y: 0x0}},
		fillString{font: "Helvetica", size: 10, x: 44.25997026698505, y: 60.94251609280899, str: "feature5"},
		pop{},
		push{},
		...
		translate{x: -82.02562654445907, y: -49.26065340167564},
		setColor{col: color.Gray16{Y: 0x0}},
		fillString{font: "Helvetica", size: 10, x: 63.67845857570907, y: 44.56094637042564, str: "feature9"},
		pop{})
	c.Check(tc.actions, check.DeepEquals, base.actions)
	if ok := reflect.DeepEqual(tc.actions, base.actions); *pics && !ok || *allPics {
		p.Add(b, ms)
	...
	for i, t := range []struct {
	...
	}{
		{
			...
			actions: []interface{}{
				...
				stroke{path: vg.Path{
					{Type: vg.MoveComp, Pos: vg.Point{X: 143.59933171592297, Y: 113.50284492303541}, Radius: 0, Start: 0, Angle: 0},
					{Type: vg.ArcComp, Pos: vg.Point{X: 152.5, Y: 152.5}, Radius: 40.0, Start: 4.487993840681956, Angle: -1.367794789850083},
				}},
				stroke{path: vg.Path{
				...
				stroke{path: vg.Path{
					...
					{Type: vg.ArcComp, Pos: vg.Point{X: 152.5, Y: 152.5}, Radius: 75.0, Start: 4.487993840681956, Angle: -1.367794789850083},
				}},
				stroke{path: vg.Path{
				...
				translate{x: -112.76690391187171, y: -158.60582306094477},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 111.37652305249671, y: 156.25596954531977, str: "0"},
				pop{},
				stroke{path: vg.Path{
				...
				translate{x: -101.11650173532223, y: -159.22164790273206},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 99.72612087594723, y: 156.87179438710706, str: "3"},
				pop{},
				stroke{path: vg.Path{
				...
				translate{x: -89.46609955877277, y: -159.83747274451935},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 88.07571869939777, y: 157.48761922889435, str: "6"},
				pop{},
				stroke{path: vg.Path{
				...
				translate{x: -77.81569738222328, y: -160.4532975863066},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 76.42531652284828, y: 158.1034440706816, str: "9"},
				pop{},
				stroke{path: vg.Path{
				...
				translate{x: -95.08016070129186, y: -155.5351367202373},
				setColor{col: color.Gray16{Y: 0x0}},
				fillString{font: "Helvetica", size: 5, x: 90.49519976379186, y: 153.1852832046123, str: "Test"},
				pop{},
				setColor{col: color.Gray{Y: 0x0}},
				setWidth{w: 1},
				setLineDash{dashes: []vg.Length(nil), offsets: 0},
				stroke{path: vg.Path{
					{Type: vg.MoveComp, Pos: vg.Point{X: 77.5170812433199, Y: 154.10059199332972}, Radius: 0, Start: 0, Angle: 0},
					{Type: vg.ArcComp, Pos: vg.Point{X: 152.5, Y: 152.5}, Radius: 75.0, Start: 3.1202498067103024, Angle: 0.1367744033971654},
				}},
				setColor{col: color.Gray{Y: 0x0}},
				setWidth{w: 1},
				setLineDash{dashes: []vg.Length(nil), offsets: 0},
				...
				stroke{path: vg.Path{
					{Type: vg.MoveComp, Pos: vg.Point{X: 138.36525744911535, Y: 115.0806326480496}, Radius: 0, Start: 0, Angle: 0},
					{Type: vg.ArcComp, Pos: vg.Point{X: 152.5, Y: 152.5}, Radius: 40.0, Start: 4.351219437284791, Angle: 0.1367744033971654},
				}},
			},
		},
	} {
